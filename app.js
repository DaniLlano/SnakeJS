document.addEventListener('DOMContentLoaded', () => {
    ...
    // fn que maneja todos los movimientos del snake
    function moveOutcomes() {

        // fn que maneja snake si choca contra un bor
        if (
    ...
    function randomApple() {
        do {
            appleIndex = Math.floor(Math.random() * squares.lenght)
